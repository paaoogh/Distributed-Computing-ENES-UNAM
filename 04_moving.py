...
server = "paolagh@132.247.186.67:public_html/static"
...
else: print ("Successfully created the directory for %s" % dating)

for file in os.listdir(git):
    filename = os.fsdecode(file)
    if filename.endswith(".json"):
        new_path = shutil.move(git+filename, new_folder)
